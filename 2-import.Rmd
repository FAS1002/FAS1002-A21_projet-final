...
Tout d'abord voici les 100 premières entrées du tableaux principal suite à la fusion des 
divers jeux de données. Pour donner une idée de la magnitude des données, ce tableau avait 
63560 observations en date du 22 décembre 2021. Heureusement, les noms de variables sont 
assez descriptif pour comprendre de quoi il s'agit.
...
MoyennePErr <- mean(df100NoNA$Pourcentage_erreur)
